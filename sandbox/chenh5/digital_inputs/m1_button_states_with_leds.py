...
Much like we did in chenh5 of the motors unit, later we will show you different (better) ways to use buttons.
...
def main():
    ...
    # ev3.Leds.set_color(ev3.Leds.RIGHT, ev3.Leds.BLACK)
     # Could also use this single command if turning both LEDs off.
