...
Authors: David Fisher and Shihao, Han.  February 2017.
...
def main():
    ...
    while not robot.touch_sensor.is_pressed:
        ...
        print("(x,y) = ({},{}), width: {}, height: {}".format(dx, dy, width, height))
        # TODO: 3. Read the Pixy values for x, y, width, and height
        # Print the values (much like the print_pixy_readings example)

        mqtt_client.send_message("on_rectangle_update", [dx, dy, width, height])
